...
const ReviewRestaurant = ({ slug, restaurantId, setRender, render }) => {
  ...
  return (
    <div className="w-full mx-auto">
      <h1 className="text-center text-xl font-bold uppercase text-textPrimary">
        Đánh giá gần đây
      </h1>
      ...
      {loading ? (
        ...
        <div>
          <div className="bg-[#fef0ed] rounded-lg py-4 my-4">
            <div className="flex flex-col justify-center text-center text-[22px] font-bold text-red-600 mb-4">
              <span className="">
            ...
            <div className="select_reviews flex items-center justify-center flex-wrap gap-4">
              {dataSelectStar &&
                dataSelectStar?.map((item, index) => (
                  <div className="select_group" key={index}>
                    ...
                    <label
                      htmlFor={item.id}
                      className={`w-[100px] inline-block text-center py-1 px-2 leading-[30px] border text-[16px] font-medium cursor-pointer rounded-md ${
                        selected === item.value

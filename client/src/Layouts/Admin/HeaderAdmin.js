...
const HeaderAdmin = ({ title }) => {
  ...
  return (
    <div className="w-full sticky z-50 top-0 h-[80px] bg-slate-800 shadow-lg dark:bg-bgThemeUI dark:border-b-[1px] dark:border-b-gray-400 flex items-center screenLarge:pl-[18%] desktop:pl-[21%] laptop:pl-[21%] pr-6">
